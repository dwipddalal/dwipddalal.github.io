...
<div class="github-card" data-github="praveenVnktsh/Bayesian-Matting" data-width="400" data-height="" data-theme="default"></div>


Here, I attempt to implement a method for solving the image matting problem of foreground and background estimation given a trimap of probable areas for a given image. The method was described in the paper: _"Yung-Yu Chuang, Brian Curless, David H. Salesin, and Richard Szeliski. A Bayesian Approach to Digital Matting. In Proceedings of IEEE Computer Vision and Pattern Recognition (CVPR 2001), Vol. II, 264-271, December 2001"_


## Fun Facts
- This one of the first few open source implementations in python on the internet.
- Took a lot of effort to run and implement correctly
